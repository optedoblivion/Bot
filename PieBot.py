...
################
    ...
    #####################
        ...
        print "Connected"
        sleep(6)
        self.irc.connections[0].privmsg("nickserv", "identify suenos")         #
        print "Identified"
        sleep(6)                                                               #
        self.irc.connections[0].privmsg("chanserv", "invite #teamdouche")      #
        print "Invited"
        sleep(6)                                                            #
...
"+--------------------------------------------------------------------------+")#
                ...
                ################################################################
                    ...
                    connection.privmsg(self.channel, "Omegle ON")              #
                    pyomegle.omegleConnect(connection,self.channel)
                ################################################################
                ...
                ################################################################
                    ...
                    connection.privmsg(self.channel, "Omegle OFF")             #
                    pyomegle.omegleDisconnect()
                ################################################################
...
#    thread.join()
    ...
    # Setup XMLRPC Server #
    ########################################################################
#    query = "SELECT address,port FROM devbot WHERE LOWER(name) = 'Hai'  \
#            LIMIT 1"                                                       #
